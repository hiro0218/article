...
---
<p>HTMLドキュメント上に存在する全角文字列を特定の文字に置き換えます。<br />
<!--more--></p>
<h2>コード</h2>
...
<h2>説明</h2>
<p>全角文字の正規表現は<a href="https://gist.github.com/tricknotes/3888158">JavaScript での全角・半角の正規表現</a>から拝借しました。<br />
(「半角以外」みたいな正規表現でもいいかも)<br />
全角文字列を指定の文字(ここでは*)に置換しているだけです。</p>