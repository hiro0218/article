...
メジャーな CSS 設計手法としては、 [BEM](http://getbem.com/)・[SMACSS](https://smacss.com/ja)・[FLOCSS](https://github.com/hiloki/flocss) などがあるが、本記事では **[ITCSS](https://itcss.io/) をプロダクトに利用した際の所感**を含めて記載をしていく。
