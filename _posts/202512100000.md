...
- [CSS-Tricks - Fighting the Space Between Inline Block Elements](https://css-tricks.com/fighting-the-space-between-inline-block-elements/) - 解決策の詳細
- [W3C CSS Flexbox Layout Module Level 1](https://www.w3.org/TR/css-flexbox-1/) - Flexboxにおける空白テキストノードの仕様
- [W3C CSS Grid Layout Module Level 1](https://www.w3.org/TR/css-grid-1/) - Gridにおける空白テキストノードの仕様
