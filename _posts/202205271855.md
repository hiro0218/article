...
- ゼロコンフィグ
- ファイルベースルーティング
- 画像最適化 / フォント最適化 / コード最適化
- 事前レンダリング

これらを組み込みでサポートしていることで、開発体験
-->
...
- SG（Static Generation）は、ビルド時に HTML を生成する
- SSR（Server-side Rendering）は、リクエストごとに HTML を生成する

---

<figure>
  <img src="https://nextjs.org/static/images/learn/data-fetching/no-pre-rendering.png" alt="事前レンダリングなし">
  <figcaption>事前レンダリングなし - <a href="https://nextjs.org/learn/basics/data-fetching/pre-rendering" target="_blank">'Pre-rendering - Pre-rendering and Data Fetching | Learn Next.js'より</a>
  </figcaption>
</figure>
...
<figure>
  <img src="https://nextjs.org/static/images/learn/data-fetching/pre-rendering.png" alt="事前レンダリング（Next.js利用時）">
  <figcaption>事前レンダリングあり - <a href="https://nextjs.org/learn/basics/data-fetching/pre-rendering" target="_blank">'Pre-rendering - Pre-rendering and Data Fetching | Learn Next.js'より</a>
  </figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Static Generation - <a href="https://nextjs.org/learn/basics/data-fetching/two-forms" target="_blank">'Pre-rendering - Pre-rendering and Data Fetching | Learn Next.js'より</a>
  </figcaption>
</figure>
