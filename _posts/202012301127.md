...
- Google は meta keywords 情報を利用しない
- Bing も meta keywords 情報を利用しない
  ただし、社員の発言と検証に依るもので信憑性は確固たるものではない
- meta keywords の記述はプラスにはならないが、マイナスにもならない
